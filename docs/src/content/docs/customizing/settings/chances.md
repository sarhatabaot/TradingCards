...
:::note
The default commented file is in the plugin jar at `settings/chances.yml`, with the source copy under `tradingcards-plugin/src/main/resources/settings/chances.yml`.
:::
