...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("kraken-core", "com.github.sarhatabaot:KrakenCore:1.8.3")
            ...
            library("flyway", "org.flywaydb:flyway-mysql:10.16.0")
            ...
            library("commons-lang", "org.apache.commons:commons-lang3:3.15.0")
