...
public class UpgradesResultRecord extends UpdatableRecordImpl<UpgradesResultRecord> implements Record4<String, String, String, String> {
    ...
    @Override
    public UpgradesResultRecord value3(String value) {
        setAmount(value);
        return this;
    }
    ...
    @Override
    public UpgradesResultRecord values(String value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UpgradesResultRecord(String upgradeId, String seriesId, String amount, String rarityId) {
        super(UpgradesResult.UPGRADES_RESULT);
