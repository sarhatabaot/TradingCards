...
public class RaritiesRecord extends UpdatableRecordImpl<RaritiesRecord> implements Record7<String, String, String, Double, Double, Integer, String> {
    ...
    @Override
    public Row7<String, String, String, Double, Double,Integer,String> valuesRow() {
    ...
    @Override
    public RaritiesRecord value7(String value) {
        setCurrencyId(value);
        return this;
    }

    @Override
    public RaritiesRecord values(String value1, String value2, String value3, Double value4, Double value5,Integer value6,String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RaritiesRecord(String rarityId, String displayName, String defaultColor, Double buyPrice, Double sellPrice,Integer customOrder, String currencyId) {
        super(Rarities.RARITIES);
